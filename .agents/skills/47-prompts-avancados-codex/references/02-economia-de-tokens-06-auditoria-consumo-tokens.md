...
3. Se faz sentido commitar, avalie se faz sentido estar "visivel" para o Codex — pode adicionar ao `AGENTS.md` (se suportado) ou documentar no AGENTS.md que o Codex nao deve abrir.
