...
A estrategia e: tratar certas saidas do Codex como ativos, e persistir em um diretorio tipo `docs/claude/` que vira parte do "cache" do projeto.
...
- Adicione no `AGENTS.md`: "Antes de explorar, verifique se ha informacao relevante em `docs/claude/`."
