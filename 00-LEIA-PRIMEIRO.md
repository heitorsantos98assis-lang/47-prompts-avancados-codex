...
Bem-vindo ao **47 Prompts Avancados de Codex**. Antes de sair usando, leia esta pagina. Sao 5 minutos que vao multiplicar o valor que voce extrai do material.
...
- **Pronto para copiar e colar**: o bloco marcado como `## PROMPT` esta formatado para ir direto ao Codex.
- **Comentado em portugues**: contexto, variacoes, dicas e sinais de que deu certo.

Os prompts NAO sao truques magicos. Eles sao prompts ENGENHEIRADOS — instrucoes pensadas para ativar comportamentos do Codex que reduzem erro, economizam tokens e aumentam previsibilidade.
...
- **Novo projeto, primeiro dia**: Prompt 04 (Onboarding) → Prompt 01 (AGENTS.md) → Prompt 02 (.codex/) → Prompt 03 (Guardrails).
...
1. **Prompt 01 — Criar AGENTS.md Perfeito** → resolve a base de tudo.
...
Esses prompts foram testados em campo, mas o Codex evolui. Se voce notar algo que nao funciona como descrito, ou se descobrir uma melhoria, registre — boas observacoes viram a proxima versao do material.
...
4. **Pular o passo de aprovacao** — varios prompts pedem para o Codex pausar e aguardar voce. Esses passos existem por um motivo. Nao force "vai logo".
